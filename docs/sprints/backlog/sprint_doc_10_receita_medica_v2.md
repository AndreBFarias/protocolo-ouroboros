---
id: DOC-10-RECEITA-MEDICA-V2
titulo: 'Sprint DOC-10 -- Extrator: receita médica registry-driven (refator)'
status: backlog
concluida_em: null
prioridade: P2
...
# Sprint DOC-10 -- Extrator: receita médica registry-driven (refator)
...
receita médica registry-driven (refator) é documento cotidiano sem regra YAML nem extrator. Cai silenciosamente em _classificar/ ou roteamento-only.
...
2. Criar src/extractors/receita_medica_v2.py.
...
`make conformance-receita_medica_v2` retorna exit 0 (≥3 amostras 4-way verdes).

## Acceptance criteria

- Tipo em tipos_documento.yaml.
- Extrator src/extractors/receita_medica_v2.py com 8+ testes.
