---
id: DOC-04-CNH
titulo: 'Sprint DOC-04 -- Extrator: CNH digital (JPEG/PDF + validade + categoria)'
status: backlog
concluida_em: null
prioridade: P2
...
# Sprint DOC-04 -- Extrator: CNH digital (JPEG/PDF + validade + categoria)
...
CNH digital (JPEG/PDF + validade + categoria) é documento cotidiano sem regra YAML nem extrator. Cai silenciosamente em _classificar/ ou roteamento-only.
...
`make conformance-cnh` retorna exit 0 (≥3 amostras 4-way verdes).

## Acceptance criteria

- Tipo em tipos_documento.yaml.
- Extrator src/extractors/cnh.py com 8+ testes.
